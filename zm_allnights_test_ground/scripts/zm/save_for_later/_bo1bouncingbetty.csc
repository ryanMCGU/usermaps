...
function init_shared( localClientNum )
{
	...
	clientfield::register( "missile", "bo1_bouncingbetty_state", VERSION_SHIP, 2, "int",&bouncingbetty_state_change, !CF_HOST_ONLY, !CF_CALLBACK_ZERO_ON_NEW_ENT );
	clientfield::register( "scriptmover", "bo1_bouncingbetty_state", VERSION_SHIP, 2, "int",&bouncingbetty_state_change, !CF_HOST_ONLY, !CF_CALLBACK_ZERO_ON_NEW_ENT );
}
