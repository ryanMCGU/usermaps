...
#precache( "string", STAMINUP_PERK_INFO_STRING );
...
{	
	...
	zm_perks::register_perk_basic_info( PERK_STAMINUP, "marathon", STAMINUP_PERK_COST, STAMINUP_PERK_INFO_STRING, GetWeapon( STAMINUP_PERK_BOTTLE_WEAPON ) );
