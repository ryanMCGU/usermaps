...
#precache( "string", SLEIGHT_OF_HAND_PERK_INFO_STRING );
...
{	
	...
	zm_perks::register_perk_basic_info( PERK_SLEIGHT_OF_HAND, "sleight", SLEIGHT_OF_HAND_PERK_COST, SLEIGHT_OF_HAND_PERK_INFO_STRING, GetWeapon( SLEIGHT_OF_HAND_PERK_BOTTLE_WEAPON ) );
	...
	zm_perks::register_perk_threads( PERK_SLEIGHT_OF_HAND, &give_speed_perk, &take_speed_perk );
...
function give_speed_perk() {
	self SetPerk("specialty_fastads");
    self SetPerk("specialty_fastequipmentuse");
    self SetPerk("specialty_fastweaponswitch");
}

function take_speed_perk( b_pause, str_perk, str_result ) {
