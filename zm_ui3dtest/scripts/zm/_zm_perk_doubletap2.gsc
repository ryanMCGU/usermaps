...
#precache( "string", DOUBLETAP2_PERK_INFO_STRING );
...
{	
	...
	zm_perks::register_perk_basic_info( PERK_DOUBLETAP2, "doubletap", DOUBLETAP2_PERK_COST, DOUBLETAP2_PERK_INFO_STRING, GetWeapon( DOUBLETAP2_PERK_BOTTLE_WEAPON ) );
	...
	zm_perks::register_perk_threads( PERK_DOUBLETAP2, &give_tap_perk, &take_tap_perk );
...
function give_tap_perk() {
    self SetPerk("specialty_fasttoss");
	self SetPerk("specialty_fastmeleerecovery");
}

function take_tap_perk( b_pause, str_perk, str_result ) {
