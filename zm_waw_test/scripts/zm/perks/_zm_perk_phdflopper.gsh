...
#define PHDFLOPPER_EXPLOSIVE_INCREASE			true 	// Increases damage of explosive weapons
#define PHDFLOPPER_EXPLOSIVE_DIVE				true 	// Explosion while diving
#define PHDFLOPPER_EXPLOSIVE_FALL				false 	// Explosion when falling from X height (MUST jump or slide off of platform)
...
#define PHDFLOPPER_EXPLOSION_EFFECT				"explosions/fx_exp_rocket_default"
